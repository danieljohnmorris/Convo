class EmailAddressesController < ApplicationController
  ...
  def show
    ...
    @to = @email_address.messages("to")
    @cc = @email_address.messages("cc")
    @from = @email_address.messages("from")
  ...
  def create
    ...
    respond_to do |format|
      if @email_address.save
        ...
        format.html { redirect_to(@email_address) }
  ...
  def update
    ...
    respond_to do |format|
      if @email_address.update_attributes(params[:email_address])
        flash[:notice] = 'EmailAddress was successfully updated.'
        format.html { redirect_to(@email_address) }
        format.xml  { head :ok }
      else
